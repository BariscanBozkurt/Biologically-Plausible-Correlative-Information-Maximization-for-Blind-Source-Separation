...
for iter1 in range(NumAverages):
    ...
    SIRS={"SIRLDInfoMax":SIRLDInfoMax,"SINRLDInfoMax":SINRLDInfoMax,"MSELDInfoMax":MSELDInfoMax,"SIRICAInfoMax":SIRICAInfoMax,"SINRICAInfoMax":SINRICAInfoMax,"MSEICAInfoMax":MSEICAInfoMax,"SIRLDInfoMaxW":SIRLDInfoMaxW,'SigPowList':SigPowList,'M':M,'r':r,'N':N,'NumAverages':NumAverages,'NumberofIterations':NumberofIterations,'rholist':rholist,'iter1':iter1}
