...
class OnlineBCA(BSSBaseClass):
    ...
    def __init__(self, s_dim, x_dim, lambda_ = 0.999, mu_F = 0.03, beta = 5, F = None, B = None, neural_OUTPUT_COMP_TOL = 1e-6, 
    ...
    @staticmethod
    @njit
    def run_neural_dynamics_antisparse(x, y, F, B, beta, gamma_hat, mu_y_start = 0.9, neural_dynamic_iterations = 100, 
    ...
    @staticmethod
    @njit
    def run_neural_dynamics_nnantisparse(x, y, F, B, beta, gamma_hat, mu_y_start = 0.9, neural_dynamic_iterations = 100, 
                                         neural_OUTPUT_COMP_TOL = 1e-7):
    ...
    def fit_batch_antisparse(self, X, n_epochs = 2, neural_dynamic_iterations = 250, neural_lr_start = 0.9, 
    ...
    def fit_batch_nnantisparse(self, X, n_epochs = 2, neural_dynamic_iterations = 250, neural_lr_start = 0.9, 
                               shuffle = False, debug_iteration_point = 1000, plot_in_jupyter = False):
