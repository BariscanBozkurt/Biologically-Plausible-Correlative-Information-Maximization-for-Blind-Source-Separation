...
class OnlinePMF:
    ...
    def fit_batch_nnantisparse(self, Y, n_epochs = 1, neural_dynamic_iterations = 250, neural_lr_start = 0.9, neural_lr_stop = 1e-3, shuffle = False, debug_iteration_point = 1000, plot_in_jupyter = False):
        ...
        for k in range(n_epochs):
            ...
            for i_sample in tqdm(range(samples)):
                ...
                s = self.run_neural_dynamics_nnantisparse(y_current, s, W, B, beta, gamma_hat, 
                                                        lr_start = neural_lr_start, lr_stop=neural_lr_stop,
                                                         neural_dynamic_iterations = neural_dynamic_iterations, 
                                                        neural_OUTPUT_COMP_TOL = neural_dynamic_tol)
    ...
    def fit_batch_sparse(self, Y, n_epochs = 1, neural_dynamic_iterations = 250, neural_lr_start = 0.9, neural_lr_stop = 1e-3, shuffle = False, debug_iteration_point = 1000, plot_in_jupyter = False):
        ...
        for k in range(n_epochs):
            ...
            for i_sample in tqdm(range(samples)):
                ...
                s = self.run_neural_dynamics_sparse(y_current, s, W, B, beta, gamma_hat, 
                                                    lr_start = neural_lr_start, lr_stop=neural_lr_stop,
                                                    neural_dynamic_iterations = neural_dynamic_iterations, 
                                                    neural_OUTPUT_COMP_TOL = neural_dynamic_tol)
    ...
    def fit_batch_nnsparse(self, Y, n_epochs = 1, neural_dynamic_iterations = 250, neural_lr_start = 0.9, neural_lr_stop = 1e-3, shuffle = False, debug_iteration_point = 1000, plot_in_jupyter = False):
        ...
        for k in range(n_epochs):
            ...
            for i_sample in tqdm(range(samples)):
                ...
                s = self.run_neural_dynamics_nnsparse(y_current, s, W, B, beta, gamma_hat, 
                                                        lr_start = neural_lr_start, lr_stop=neural_lr_stop,
                                                        neural_dynamic_iterations = neural_dynamic_iterations, 
                                                        neural_OUTPUT_COMP_TOL = neural_dynamic_tol)
    ...
    def fit_batch_simplex(self, Y, n_epochs = 1, neural_dynamic_iterations = 250, neural_lr_start = 0.9, neural_lr_stop = 1e-3, shuffle = False, debug_iteration_point = 1000, plot_in_jupyter = False):
        ...
        for k in range(n_epochs):
            ...
            for i_sample in tqdm(range(samples)):
                ...
                s = self.run_neural_dynamics_simplex(y_current, s, W, B, beta, gamma_hat, 
                                                        lr_start = neural_lr_start, lr_stop=neural_lr_stop,
                                                        neural_dynamic_iterations = neural_dynamic_iterations, 
                                                        neural_OUTPUT_COMP_TOL = neural_dynamic_tol)
    ...
    def fit_batch_olshaussen(self, Y, n_epochs = 1, neural_dynamic_iterations = 250, neural_lr_start = 0.9, neural_lr_stop = 1e-3, shuffle = False, debug_iteration_point = 1000, plot_in_jupyter = False):
                    ...
                    if (i_sample % debug_iteration_point) == 0:
                        ...
                        if plot_in_jupyter:
                            ...
                            pl.subplots_adjust(right=0.97,\
                                                ...
                                                wspace=0.1,\
                                                hspace=0.1)
                            pl.suptitle('The receptive fields after {}'.format(n_iterations), fontsize = 25)
                            clear_output(wait=True)
                            display(pl.gcf())   
        self.W = W
        self.B = B
