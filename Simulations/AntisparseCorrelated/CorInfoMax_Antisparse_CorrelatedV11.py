...
pickle_name_for_results = "simulation_results_correlated_antisparseV11.pkl"
...
seed_list = np.array([9632514*i for i in range(1, NumAverages+1)]) ## Seeds for reproducibility
########################################################################################
########################################################################################
###                                                                                  ###
###                        SIMULATION                                                ###
