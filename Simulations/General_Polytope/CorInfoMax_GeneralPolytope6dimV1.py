...
pickle_name_for_results = "simulation_results_general_polytope_6dimV1.pkl"

N = 500000 ## Number of data points
NumberofSources = 6 ## Number of source vectors
NumberofMixtures = 12 ## Number of mixture vectors
...
seed_list = np.array([111444777 * i for i in range(NumAverages)]) ## Seeds for reproducibility
...
for iter1 in range(NumAverages): ## Loop over number of averages
    ...
    try: # Try Except for SVD did not converge error (or for any other error)
        ...
        print(str(e))
        CorInfoMax_Dict = {'trial' : trial, 'seed' : seed_, 'Model' : 'CorInfoMax2',
                            'SINR' : -999, 'SINRlist':  str(e), 'SNR' : None,
                            'S' : None, 'A' : None, 'X': None, 'Wf' : None, 'SNRinp' : None, 
                            'execution_time' : None}
