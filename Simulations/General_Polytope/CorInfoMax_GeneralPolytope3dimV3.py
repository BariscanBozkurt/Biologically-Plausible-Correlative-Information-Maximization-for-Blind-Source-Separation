...
pickle_name_for_results = "simulation_results_general_polytope_3dimV3.pkl"

N = 500000 ## Number of data points
NumberofSources = 3 ## Number of source vectors
NumberofMixtures = 7 ## Number of mixture vectors
...
seed_list = np.array([222334 * i for i in range(NumAverages)]) ## Seeds for reproducibility
